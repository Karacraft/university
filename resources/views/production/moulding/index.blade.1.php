    ...
    <div class="mt-4 animated fadeIn">
        ...
        <div class="mt-4">
            ...
            <div id="level1courses" class="hideme mt-2 animated fadeIn">
                ...
                <div class="row">
                    <div class="col-2">
                        <a id="machines" class="btn btn-secondary shadow-sm text-white btn-sm btn-block" onclick="showCourse(this)">Machines 1.1</a>
                    </div>
                    <div class="col-2">
                        <a id="molds" class="btn btn-secondary shadow-sm text-white btn-sm btn-block" onclick="showCourse(this)">Molds 1.2</a>
                    </div>
                    <div class="col-2">
                        <a id="materials" class="btn btn-secondary shadow-sm text-white btn-sm btn-block" onclick="showCourse(this)">Materials 1.3</a>
                    </div>
                    <div class="col-2">
                        <a id="auxillaries" class="btn btn-secondary shadow-sm text-white btn-sm btn-block" onclick="showCourse(this)">Auxillaries 1.4</a>
                    </div>
                    <div class="col-2">
                        <a id="mold_defacts" class="btn btn-secondary shadow-sm text-white btn-sm btn-block" onclick="showCourse(this)">Mold Defects 1.5</a>
                    </div>
                </div>
            ...
            <div class="mt-4 hideme animated fadeIn " id="machines_courses">
                <div class="row m-2">
            ...
            <div class="mt-4 hideme animated fadeIn" id="mold_courses">
                <div class="row m-2">
            ...
            {{-- Sub-Level Courses --}}
            <div class="mt-4 hideme" id="auxillaries_courses">
                <h3 class="text-center mt-5">Auxillaries Course Under Construction</h3>
            </div>

            {{-- Sub-Level Courses --}}
            <div class="mt-4 hideme" id="mold_defacts_courses">
