...
@section('content')
    <div class="container mt-4 animated fadeIn">
        ...
        <div class="row text-center bg-primary text-white py-2">
            ...
            <div class="col-10">
                <h4>Moulding &rarr; Machines &rarr; Process Trouble Shooting 1.1.10</h4>
            </div>
            <div class="col-1">
                {{-- <a href="">&#62;</a> --}}
            </div>
        ...
        <div class="row py-2">
            <div class="col-12">
                <h2 class="text-primary">Process Trouble Shooting</h2>
            </div>
            {{-- <div class="col-1">
        ...
        <div class="mb-4">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <div class="embed-responsive embed-responsive-16by9 mb-3">
                            <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/xDzSVK6PWCo" allowfullscreen></iframe>
                        </div>
                    </div>    
                </div>     
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="embed-responsive embed-responsive-16by9 mb-3">
                            <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/5hgXRlbgr8o" allowfullscreen></iframe>
                        </div>
                    </div>    
                </div>    
            </div>   
