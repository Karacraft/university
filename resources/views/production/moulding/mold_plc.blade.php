    ...
    <div class="card border-primary mb-3">
        <div class="card-header bg-primary">
            @component('includes.course_header_links')
                ...
                @endslot
                <h4>Moulding &rarr; Machines &rarr; Control Panels / PLC 1.1.8</h4>
            @endcomponent
        </div>

        <div class="card-body">
            <h3 class="card-title">Control Panels / PLC </h3>
            <br>
            ...
            <div class="mb-4">
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-sm-12 col-md-12">
                            <div class="embed-responsive embed-responsive-16by9 mb-3">
                                <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/IC9rNrrr5Qk" allowfullscreen></iframe>
                            </div>
                        </div>    
                    </div>    
                </div>  
