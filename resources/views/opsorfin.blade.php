                        ...
                        <div class="card-body">
                            <div class="row align-items-center h-100">
                                <div class="col-lg-6 col-md-12 col-sm-12 text-muted text-center p-5">
                                    <div class="row">
                                        <div class="col">
                                            <a href="https://app.powerbi.com/view?r=eyJrIjoiMjAyYWRlOGMtOTM1Ny00M2FkLWEwZTUtZWVlOGNjOTE2Njk1IiwidCI6IjdmMmY4ZTY3LWFiZjYtNDgyZS04MWI2LWQ2OWY2MTQxZTEzMyIsImMiOjl9">
                                ...
                                <div class="col-lg-6 col-md-12 col-sm-12 text-center text-muted p-5">
                                    <div class="row">
                                        <div class="col">
                                            <a href="https://app.powerbi.com/view?r=eyJrIjoiZmZmOTAwNDctYzkxOC00ZjIxLWI1NmYtYWFiZmYzZWZjMGNkIiwidCI6IjdmMmY4ZTY3LWFiZjYtNDgyZS04MWI2LWQ2OWY2MTQxZTEzMyIsImMiOjl9">
